...
most_rape_victims_in_2016.toPandas().plot(kind='bar', x='state_ut', y='total_rape_victims', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
most_rape_victims_in_2017.toPandas().plot(kind='bar', x='state_ut', y='total_rape_victims', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
most_rape_victims_in_2018.toPandas().plot(kind='bar', x='state_ut', y='total_rape_victims', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
total_rape_victims.toPandas().plot(kind='bar', x='state_ut', y='total_rape_victims', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
