...
# most_10_criminal_cases_in_2017.toPandas().plot(kind='bar', x='state_ut', y='total_criminal_cases', figsize=(20, 10),color='r')
# plt.xlabel("state")
# plt.ylabel("count")
...
# most_10_criminal_cases_in_2018.toPandas().plot(kind='bar', x='state_ut', y='total_criminal_cases', figsize=(20, 10),color='r')
# plt.xlabel("state")
# plt.ylabel("count")
...
# total_no_of_cases.toPandas().plot(kind='bar', x='state_ut', y='total_cases', figsize=(20, 10),color='r')
# plt.xlabel("state")
# plt.ylabel("count")
