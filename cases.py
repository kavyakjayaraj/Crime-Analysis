...
most_10_criminal_cases_in_2016=spark.read.csv('hdfs://localhost:9000//bigdata_project/2016_cases/000000_0',inferSchema=True)
...
#
# most_10_criminal_cases_in_2017.toPandas().plot(kind='bar', x='state_ut', y='no_total_criminal_cases', figsize=(20, 10),color='r',label='maharshra-487')
# plt.xlabel("x")
# plt.ylabel("y")
...
# most_10_criminal_cases_in_2018=spark.read.csv('hdfs://localhost:9000//bigdata_project/2018_cases/000000_0',inferSchema=True)
