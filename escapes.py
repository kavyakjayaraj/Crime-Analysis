...
most_persons_escaped_in_2016.toPandas().plot(kind='bar', x='state_ut', y='total_persons_escaped', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
most_persons_escaped_in_2017.toPandas().plot(kind='bar', x='state_ut', y='total_persons_escaped', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
most_persons_escaped_in_2018.toPandas().plot(kind='bar', x='state_ut', y='total_persons_escaped', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
...
total_no_of_escapes.toPandas().plot(kind='bar', x='state_ut', y='total_escapes', figsize=(20, 10))
plt.xlabel("state")
plt.ylabel("count")
